...
const COMMON = ["name","type","visible","locked","opacity","blendMode","isMask","x","y","width","height","rotation","layoutAlign","layoutGrow","layoutPositioning","clipsContent","strokeWeight","strokeTopWeight","strokeRightWeight","strokeBottomWeight","strokeLeftWeight","strokeAlign","strokeCap","strokeJoin","strokeMiterLimit","dashPattern","cornerRadius","topLeftRadius","topRightRadius","bottomLeftRadius","bottomRightRadius","cornerSmoothing","layoutMode","layoutWrap","primaryAxisSizingMode","counterAxisSizingMode","primaryAxisAlignItems","counterAxisAlignItems","paddingLeft","paddingRight","paddingTop","paddingBottom","itemSpacing","counterAxisSpacing","overflowDirection","minWidth","maxWidth","minHeight","maxHeight","fillStyleId","strokeStyleId","effectStyleId","gridStyleId"];
